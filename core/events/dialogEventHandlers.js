...
var dialogSave = function (dialogData) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, electron_1.dialog.showSaveDialog(win, {
                    buttonLabel: dialogData.buttonLabel,
                    defaultPath: electron_1.app.getPath('home'),
                    filters: dialogData.filters,
                    title: dialogData.title,
...
var createProperties = function (dialogData) {
    var properties = [];
    if (dialogData.allowMultiSelection)
        properties.push('multiSelections');
    switch (dialogData.selectionType) {
        case dialogEventData_1.SelectionType.File:
            properties.push('openFile');
            break;
        case dialogEventData_1.SelectionType.Directory:
...
//# sourceMappingURL=dialogEventHandlers.js.map